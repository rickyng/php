...
echo "<div class='col-md-12'>";
    ...
    if($_POST){
        ...
        if($user->emailExists($_POST['email'])){
            ...
            $request['access_level']='Customer';
            $request['access_code']=$utils->getToken();
            $request['status']=1;
            ...
            if($user->create($request)){
                ...
                $body.="Please click the following link to verify your email and login: {$home_url}verify/?access_code={$request['access_code']}";
